...
export default function CashInRequestCard({ request, handleAccept, handleCancel, index, setConfirmFormOpen, confirmFormOpen, setConfirmData }) {
        ...
        <tr className="border-b border-gray-300 hover:bg-gray-100 dark:border-gray-700 dark:hover:bg-gray-800">
            ...
            <td className="py-2 px-4 text-[#737373]">
                <button onClick={() => {
                    ...
                    setConfirmFormOpen(!confirmFormOpen)
                    setConfirmData(request)
                }} disabled={status !== "pending"} className={`font-bold text-[1rem] capitalize btn bg-green-600 text-white disabled:bg-gray-500`}>Accept</button>
            </td>
            <td className="py-2 px-4 text-[#737373]">
